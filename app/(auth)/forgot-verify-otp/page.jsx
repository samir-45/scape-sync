...
import ForgotVerifyOtpForm from "@/components/ForgotVerifyOtpForm";


export default function ForgotVerifyOtpPage({searchParams}) {
        ...
        <div className="bg-white font-sans text-gray-900">
            <div className="min-h-screen flex flex-col items-center justify-center py-12">
                <main className="w-full p-3 max-w-md">
                    ...
                    <ForgotVerifyOtpForm email={email}></ForgotVerifyOtpForm>
